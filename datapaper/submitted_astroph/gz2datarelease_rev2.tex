...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{flowchart.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{classification_histogram.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.3in]{user_consistency.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{gz2_type_fractions.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{gz2_baselines.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{gz2_bias_demo_task01.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{stripe82_coadd_compare.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.3in]{gz1_gz2_trumpet.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{gz1_gz2.pdf}
...
%Comparison of GZ2 to the expert catalogues focuses on categories included in both classification schemes: bars, rings, and interacting galaxies. We also examine the relationship between the expert-determined T-types and the decision tree in GZ2.
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{na_bars.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{efigi_bars.pdf}
...
In the NA10 catalogue, 18.2\% of all galaxies (30\% of disks) have a ring. Of those, 10\% are nuclear rings, 74\% are inner rings, and 32\% are outer rings (the sum is more than 100\% since one-third of ringed galaxies have multiple rings flagged). NA10 and GZ2 ring classifications are compared for the oblique galaxies in both samples. No cut is applied to the vote fraction for the ``anything odd'' question; even a comparatively low cut of $p_\mathrm{odd}>0.2$ eliminates roughly 40\% of the ringed galaxies identified in NA10. %We therefore analysed the GZ2 ring vote fraction for the entire sample of oblique disks, with the caveat that some 13\% of these classifications are the result of three or fewer votes.

\begin{figure}
\includegraphics[angle=0,width=3.3in]{na_gz2_rings_labelfixed.pdf} % Note - I fixed this figure in Keynote because the legend was switched. Absolutely should rewrite the code to make the figure itself again when I have a free moment.
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{efigi_rings.pdf}
...
\begin{figure}
%\includegraphics[angle=0,width=3.3in]{na_gz2_mergers.pdf}
\includegraphics[angle=0,width=3.3in]{na_mergers_new.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{efigi_mergers.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{na_ttype.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{spiraltightness_color.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{bulgeprominence_color.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.3in]{eureqa.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{efigi_bulgearms.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{hc_histogram.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.3in]{hc_gz2_bulge_contour.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.3in]{hc_gz2_bar.pdf}
...
The development of Galaxy Zoo 2 was supported by The Leverhulme Trust. KWW and LFF would like to acknowledge support from the US National Science Foundation under grant DRL-0941610. CJL acknowledges support from the Science and Technology Facilities Council (STFC) Science in Society program. KS gratefully acknowledges support from Swiss National Science Foundation Grant PP00P2\_138979/1. TM acknowledges funding from the STFC ST/J500665/1. RCN was partially supported by STFC grant ST/K00090X/1. BDS acknowledges support from Worcester College, Oxford, and from the Oxford Martin School program on computational cosmology. Please contact the author(s) to request access to research materials discussed in this paper. 
...
\enddata
\tablecomments{The full, machine-readable version of this table is available at http://data.galaxyzoo.org. A portion is shown here for guidance on form and content, which is described in Section~\ref{sec-catalogue} and Appendix~\ref{app-gzstring} (for $gz2\_class$). The full table contains 252,750 rows (one for every galaxy in the sample), and 226 columns, with six variables for each of the 37 GZ2 morphology classifications. }
\end{deluxetable}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{gz2_examples.pdf}
