...
\begin{figure}
\includegraphics[angle=0,width=3.3in]{figures/na_gz2_rings_labelfixed.pdf} % Note - I fixed this figure in Keynote because the legend was switched. Absolutely should rewrite the code to make the figure itself again when I have a free moment.
